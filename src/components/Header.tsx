      ...
      <div className="container mx-auto flex items-center justify-between py-4 px-4">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a
            ...
            className="flex items-center gap-2 bg-primary text-primary-foreground px-5 py-2.5 rounded-full text-sm font-body font-bold tracking-wide hover:opacity-90 transition-opacity"
          >
            <Phone size={14} />
            Agendar
          </a>
